...
INSERT INTO "new_Exercise" ("category", "createdAt", "equipment", "id", "muscleGroup", "name", "updatedAt", "userId") SELECT "category", "createdAt", "equipment", "id", "muscleGroup", "name", "updatedAt", "userId" FROM "Exercise";
DROP TABLE "Exercise";
